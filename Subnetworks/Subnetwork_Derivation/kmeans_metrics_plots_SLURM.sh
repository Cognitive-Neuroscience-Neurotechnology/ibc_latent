...
#SBATCH --job-name=kmeans_metrics
...
srun apptainer exec ${container} python /home/hmueller2/ibc_code/ibc_latent/Subnetworks/kmeans_metrics_plots.py --subject ${subject} --dir ${working_dir}
